...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row woocommerce-form-row--full form-row form-row-full">
		...
		<input type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="password_1" id="password_1" autocomplete="new-password" required aria-required="true" placeholder=" " />
	</p>
	<p class="woocommerce-form-row woocommerce-form-row--full form-row form-row-full">
		...
		<input type="password" class="woocommerce-Input woocommerce-Input--text input-text" name="password_2" id="password_2" autocomplete="new-password" required aria-required="true" placeholder=" " />
	</p>
	...
	<p class="woocommerce-form-row form-row form-row--buttons">
		...
		<a href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>" class="woocommerce-Button button--back-to-login"><?php esc_html_e( 'Wróc do logowania', 'sense7' ); ?></a>
	</p>
